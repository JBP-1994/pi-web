    ...
    >
      ...
      >
        ...
        <div className="file-viewer-controls">
          ...
          <div className="file-viewer-actions" style={{ display: "flex", alignItems: "center", gap: 2 }}>
              ...
              <>
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    borderRadius: 4,
                    color: wrapLines ? "var(--text)" : "var(--text-dim)",
                    cursor: "pointer",
                  }}
                  onMouseEnter={(e) => { if (!wrapLines) { e.currentTarget.style.color = "var(--accent)"; e.currentTarget.style.background = "var(--bg-hover)"; } }}
                  onMouseLeave={(e) => { e.currentTarget.style.color = wrapLines ? "var(--text)" : "var(--text-dim)"; e.currentTarget.style.background = wrapLines ? "var(--bg-selected)" : "transparent"; }}
                >
                  <svg
                    width="12"
                    height="12"
